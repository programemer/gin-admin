...
func (baseMenuService BaseMenuService) DeleteBaseMenu(id int) (err error) {
	err = global.GVA_DB.First(&entity.SysBaseMenu{}, "parent_id = ?", id).Error
	if err == nil {
	...
	err = global.GVA_DB.First(&entity.SysAuthority{}, "default_router = ?", menu.Name).Error
	if err == nil {
...
// @return: err error
func (baseMenuService *BaseMenuService) UpdateBaseMenu(menu entity.SysBaseMenu) (err error) {
...
func (baseMenuService *BaseMenuService) GetBaseMenuById(id int) (menu entity.SysBaseMenu, err error) {
