...
func (dictionaryService *DictionaryService) CreateSysDictionary(sysDictionary entity.SysDictionary) (err error) {
	if (!errors.Is(global.GVA_DB.First(&entity.SysDictionary{}, "type = ?", sysDictionary.Type).Error, gorm.ErrRecordNotFound)) {
...
// @param: sysDictionary model.SysDictionary
// @return: err error
func (dictionaryService *DictionaryService) DeleteSysDictionary(sysDictionary entity.SysDictionary) (err error) {
...
// @param: sysDictionary *model.SysDictionary
// @return: err error
func (dictionaryService *DictionaryService) UpdateSysDictionary(sysDictionary *entity.SysDictionary) (err error) {
...
func (dictionaryService *DictionaryService) GetSysDictionary(Type string, Id uint, status *bool) (sysDictionary entity.SysDictionary, err error) {
	var flag = false
	if status == nil {
		flag = true
	} else {
